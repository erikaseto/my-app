  ...
  const experiences = [
    {
      ...
      details: [
        ...
        "Administered and documented immunizations during high-volume vaccination events, ensuring precise clinical documentation.",
      ],
    },
    {
      ...
      details: [
        "Ensured data accuracy by reviewing patient profiles, medication histories, and prescriptions, identifying discrepancies and resolving documentation issues.",
      ...
      <main className="relative z-10 min-h-screen text-gray-900 font-sans max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-left mb-6">
            I am a licensed pharmacist and graduate student in software development with a 
            strong interest in clinical informatics and healthcare technology. After years of working in 
            fast-paced retail pharmacy settings, I developed a deep appreciation for efficient workflows, 
            accurate data, and user-friendly systems.
            </p>
            <p className="text-lg text-left">
            Through my master’s program, I’ve gained experience in SQL, Python, system design, and web 
            application development. I’m passionate about combining my clinical background with my technical 
            training to improve workflows and contribute to more effective, patient-centered care.
          </p>
        </section>
